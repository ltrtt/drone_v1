...
bool bmp280Init(void)
{
	...
	bmp280ID = IIC_ReadByte(BMP280_ADDR, BMP280_CHIP_ID);	/* 读取bmp280 ID*/
	...
	/* 读取校准数据 */
	IIC_Read(BMP280_ADDR, BMP280_TEMPERATURE_CALIB_DIG_T1_LSB_REG, 24, (u8 *)&bmp280Cal);
	IIC_WriteByte(BMP280_ADDR, BMP280_CTRL_MEAS_REG, BMP280_MODE);
	IIC_WriteByte(BMP280_ADDR, BMP280_CONFIG_REG, 5 << 2);		/*配置IIR滤波*/
...
static void bmp280GetPressure(void)
{
	...
	IIC_Read(BMP280_ADDR, BMP280_PRESSURE_MSB_REG, BMP280_DATA_FRAME_SIZE, data);
